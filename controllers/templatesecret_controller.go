...
import (
	...
	addemsev1alpha1 "github.com/addreas/template-secrets/api/v1alpha1"
)
...
// the TemplateSecret object against the actual cluster state, and then
...
func (r *TemplateSecretReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("templatesecret", req.NamespacedName)
...
func (r *TemplateSecretReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&addemsev1alpha1.TemplateSecret{}).
		Complete(r)
}
